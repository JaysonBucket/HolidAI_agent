...
- to make interaction more engaging the agent also thows international holiday traditions for the current day
...
- as you are going to set up a solely web grounded, declarative only agent it should work free of charge even without M365 Copilot license (no guarantees, see complementary links below, MUST be created with Agent Builder in that case)
...
- _deploy_ to your org: https://learn.microsoft.com/en-us/microsoft-365/admin/manage/manage-copilot-agents-integrated-apps?view=o365-worldwide (only when set up in Copilot Studio)
- _pint it_ to create maximum visibility https://learn.microsoft.com/en-us/microsoft-365/admin/manage/manage-pinning-agents?view=o365-worldwide (only when set up in Copilot Studio)
